...
use crate::actor::echo::{EchoAgent, EchoMessage, EchoStats, echo, get_stats, ping};
...
impl Supervisor {
    async fn spawn_child(
        ...
        let (actor_ref, _handle) =
            Actor::spawn(Some(name.to_string()), EchoAgent, name.to_string())
                .await
...
pub async fn list_children(
    ...
    rx.await
        .map_err(|e| crate::CoreError::Actor(format!("ListChildren reply error: {}", e)))
}
